...
In order to support loading of multiple wallets in anes-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is anes.cpp.
...
Changes to anes.cpp
----------------------
anes.cpp is the entry point into anes-qt, and as such, will require some minor modifications to provide hooks for
