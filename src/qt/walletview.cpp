                                          ...
                                          walletModel(0)
{
    ...
    // Clicking on a transaction on the holding pre-selects the transaction on the transaction history page
    connect(holdingPage, SIGNAL(transactionClicked(QModelIndex)), transactionView, SLOT(focusTransaction(QModelIndex)));
...
void WalletView::setBitcoinGUI(BitcoinGUI* gui)
{
    if (gui) {
        ...
        // Clicking on a transaction on the holding page simply sends you to transaction history page
        connect(holdingPage, SIGNAL(transactionClicked(QModelIndex)), gui, SLOT(gotoHistoryPage()));
...
void WalletView::setClientModel(ClientModel* clientModel)
{
    ...
    holdingPage->setClientModel(clientModel);
...
void WalletView::setWalletModel(WalletModel* walletModel)
{
    ...
    holdingPage->setWalletModel(walletModel);
    QSettings settings;
    if (settings.value("fShowMasternodesTab").toBool()) {
...
void WalletView::gotoHoldingPage()
{
    setCurrentWidget(holdingPage);
}
