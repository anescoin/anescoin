                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ANES-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    holdingAction = new QAction(QIcon(":/icons/holding"), tr("&Holding"), this);
    holdingAction->setStatusTip(tr("Show holding status of wallet"));
    holdingAction->setToolTip(holdingAction->statusTip());
    holdingAction->setCheckable(true);
#ifdef Q_OS_MAC
    holdingAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_2));
#else
    holdingAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
#endif
    tabGroup->addAction(holdingAction);

    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Send"), this);
    sendCoinsAction->setStatusTip(tr("Send coins to a ANES address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and anes: URIs)"));
    ...
    connect(holdingAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(holdingAction, SIGNAL(triggered()), this, SLOT(gotoHoldingPage()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ANES Core"), this);
    aboutAction->setStatusTip(tr("Show information about ANES Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ANES"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ANES addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ANES addresses"));
    ...
    openAction->setStatusTip(tr("Open a ANES: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ANES Core help message to get a list with possible ANES command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        toolbar->addAction(holdingAction);
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    holdingAction->setEnabled(enabled);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ANES Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::gotoHoldingPage()
{
    holdingAction->setChecked(true);
    if (walletFrame) walletFrame->gotoHoldingPage();
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ANES network", "", count));
}
...
{
    QString strTitle = tr("ANES Core"); // default title
