...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ANES features */
        {"anes", "masternode", &masternode, true, true, false},
        {"anes", "masternodelist", &masternodelist, true, true, false},
        {"anes", "mnbudget", &mnbudget, true, true, false},
        {"anes", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"anes", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"anes", "mnsync", &mnsync, true, true, false},
        {"anes", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use anesd, or the -server option to anes-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> anes-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:41202/\n";
}
