...
RESOURCES += src/qt/anes.qrc src/qt/anes_locale.qrc

TRANSLATIONS += src/qt/locale/anes_bg.ts \
                src/qt/locale/anes_de.ts \
                src/qt/locale/anes_en.ts \
                src/qt/locale/anes_es.ts \
                src/qt/locale/anes_fi.ts \
                src/qt/locale/anes_fr.ts \
                src/qt/locale/anes_it.ts \
                src/qt/locale/anes_ja.ts \
                src/qt/locale/anes_pl.ts \
                src/qt/locale/anes_pt.ts \
                src/qt/locale/anes_ru.ts \
                src/qt/locale/anes_sk.ts \
                src/qt/locale/anes_sv.ts \
                src/qt/locale/anes_vi.ts \
                src/qt/locale/anes_zh_CN.ts \
                src/qt/locale/anes_zh_TW.ts
